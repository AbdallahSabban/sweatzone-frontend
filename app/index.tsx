...
import {
    ...
    Keyboard, Platform, Image, Button
} from 'react-native';
import { useRouter, Link } from 'expo-router';
import { useNavigation } from '@react-navigation/native';
import { useFonts } from 'expo-font';
import axios from 'axios';
import {HelloResponse} from "@/.expo/types/api";
...
export default function SignInScreen() {
    ...
    useEffect(() => {
        axios
            .get<HelloResponse>('http://192.168.1.9:3000/api/hello') // Emulator alias
    ...
    const handleForgotPassword = () => {
        router.push('/forgot-password'); // Navigate to Forgot Password screenn
    };
        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
            ...
            >
                ...
                <ScrollView contentContainerStyle={styles.scrollContainer} keyboardShouldPersistTaps="handled">
                    ...
                    <Text style={[styles.appName, { fontFamily: 'RussoOne' }]}>{message || 'Loading.s.'}</Text>
